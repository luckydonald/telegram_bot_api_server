...
# Package meta-data.
NAME = 'telegram_bot_api_server'
DESCRIPTION = 'Standalone Telegram Bot API Server'
URL = 'https://github.com/luckydonald/telegram_bot_api_server'
EMAIL = 'telegram_bot_api_server+pip@luckydonald.de'
AUTHOR = 'luckydonald'
...
# thanks to https://github.com/navdeep-G/setup.py
# https://github.com/navdeep-G/setup.py/blob/3a03ee20c0d2b795c8d5cb1aa1d7c3c6468d2ffc/setup.py
